  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#d94e1f] to-[#f09819] font-[Poppins,sans-serif] text-white">
      ...
      <nav className="fixed top-0 w-full px-8 py-6 flex justify-between items-center z-50 bg-gradient-to-b from-[#d94e1f]/80 to-transparent backdrop-blur-[2px]">
        <Link to="/" className="text-2xl font-black tracking-wider cursor-pointer">tapd.</Link>
        <div className="hidden md:flex gap-12 text-sm font-bold uppercase tracking-widest">
            ...
            <Link to="/#sponsors" className="hover:text-orange-200 transition-colors relative group">
                Sponsors
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-white transition-all group-hover:w-full"></span>
            </Link>
      ...
      <div className="max-w-4xl mx-auto px-6 py-32">
        ...
        <div>
          ...
          {/* Reduced font size from text-sm/base to text-xs/sm */}
          <div className="space-y-8 text-xs md:text-sm font-light opacity-90 leading-relaxed">
              <section>
                <h2 className="text-base font-bold mb-2 opacity-100">Introduction</h2>
                <p>
              ...
              <section>
                <h2 className="text-base font-bold mb-2 opacity-100">Information We Collect</h2>
                <p className="mb-2">
              ...
              <section>
                <h2 className="text-base font-bold mb-2 opacity-100">Data Usage and Sharing</h2>
                <p className="mb-2">
              ...
              <section>
                <h2 className="text-base font-bold mb-2 opacity-100">Data Retention and Deletion Policy</h2>
                <p>
              ...
              <section>
                <h2 className="text-base font-bold mb-2 opacity-100">Data Security</h2>
                <p>
              ...
              <section>
                <h2 className="text-base font-bold mb-2 opacity-100">User Rights and Controls</h2>
                <p>
              ...
              <section>
                <h2 className="text-base font-bold mb-2 opacity-100">Accessibility</h2>
                <p>
              ...
              <section>
                <h2 className="text-base font-bold mb-2 opacity-100">Compliance with Google Play Requirements</h2>
              ...
              <section>
                <h2 className="text-base font-bold mb-2 opacity-100">Contact Information</h2>
                <p>
              ...
              <section>
                <h2 className="text-base font-bold mb-2 opacity-100">Educational and Research Use</h2>
                <p>
              ...
              <section>
                <h2 className="text-base font-bold mb-2 opacity-100">Appropriate Language and Content</h2>
                <p>
              ...
              <section>
                <h2 className="text-base font-bold mb-2 opacity-100">Copyright Adherence</h2>
                <p>
              ...
              <section>
                <h2 className="text-base font-bold mb-2 opacity-100">Messaging and Posts</h2>
                <p>
              ...
              <section>
                <h2 className="text-base font-bold mb-2 opacity-100">Network Storage</h2>
                <p>
              ...
              <section>
                <h2 className="text-base font-bold mb-2 opacity-100">User Authentication</h2>
                <p>
              ...
              <section>
                <h2 className="text-base font-bold mb-2 opacity-100">Violations and Disciplinary Action</h2>
                <p>
              ...
              <section>
                 <h2 className="text-base font-bold mb-2 opacity-100">Harassment Policy</h2>
                 <p>
              ...
              <section>
                 <h2 className="text-base font-bold mb-2 opacity-100">Admin Rights to Content</h2>
                 <p>
              ...
              <section>
                 <h2 className="text-base font-bold mb-2 opacity-100">Privacy Policy</h2>
                 <p>
